...
- Increasing mpsc buffer size reduced orchestration overhead in profiling, but this trades lower scheduling pressure for higher peak memory usage. We could further experiment with larger underlying CSV read buffers, batching operations/messages on mpsc, and related tuning to find a better sweet spot for throughput/latency.
